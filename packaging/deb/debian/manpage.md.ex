% count-files(SECTION) | User Commands
%
% "January 11 2026"
...
count-files - program to do something

# SYNOPSIS

**count-files** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**count-files** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **count-files** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**count-files** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    count-files. See **foo.conf**(5) for further details.
...
**count-files** provides some return codes, that can be used in scripts:
...
vboxuser <your@email.com>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 vboxuser
